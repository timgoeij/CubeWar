...
public class multiplayerarmy : MonoBehaviour
{
	...
	public virtual void Update()
	{
		...
		Debug.DrawRay(rayvector, fighter.TransformDirection(Vector3.forward),Color.red);
	...
	void dead()
	{
		...
		{
			controller.updatemoney(reward,false,1);
