...
public class bowfighter : army 
{
	...
	void fire()
	{
		...
		Transform arrow = Transform.Instantiate(arrowprefab,shootingpoint.position,this.transform.rotation) as Transform;
		arrowscript = arrow.GetComponent<weapon>();
